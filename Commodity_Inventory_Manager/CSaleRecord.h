...
public:
    ...
    // 构造函数
    CSaleRecord(const QString& orderId, int quantity, double discountRate, const QDate& orderDate, const QString& contactPhone);
    ...
    void SaveSaleRecord(QTextStream &aStream) const;
    void ReadSaleRecord(QTextStream &aStream);
